...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            # logging.info(f"Drop null values colums df")
            # df = self.drop_missing_values_columns(df=df,report_key_name="missing_values_within_dataset")
            ...
            # logging.info("encoding M-->1 and F--> 0")
